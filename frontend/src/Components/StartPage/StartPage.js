      ...
      <div className={StartPageStyle.contentwrapper}>
        <div className={StartPageStyle.startpageFull}>
          ...
          <div className={StartPageStyle.StartPageSignup}>
            ...
            <img data-aos="fade-left" src={Emoji} alt="Emoji" className={StartPageStyle.StartPage}  />
          </div>
        </div>
        <div className={StartPageStyle.StartPageStudyroom}>
          <img data-aos="fade-right" src={DashBoardImg} alt="Studyroom" className={StartPageStyle.StartPageImg} />
        ...
        <div className={StartPageStyle.StartPageMyStudy}>
          <img data-aos="fade-left" src={StudyRoomImg} alt="Studyroom" className={StartPageStyle.StartPageImg} />
